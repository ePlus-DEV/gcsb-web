    ...
    >
      ...
      <div className="not-prose grid gap-5 md:grid-cols-2">
        ...
        <Link
          ...
          className="group rounded-3xl border border-slate-200 bg-white p-6 shadow-sm transition hover:-translate-y-0.5 hover:border-violet-300 hover:shadow-lg dark:border-white/10 dark:bg-white/[0.035] dark:hover:border-violet-400/40"
        >
          <div className="flex items-start justify-between gap-4">
