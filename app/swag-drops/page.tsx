...
const description =
  "Browse Google Skills Arcade swag drops, reward tiers, prize slots, and confirmed reward announcements by season."
...
export default function SwagDropsArchivePage() {
  const itemList = {
    ...
    itemListElement: ARCADE_SWAG_SEASONS.map((season, index) => ({
      "@type": "ListItem",
      position: index + 1,
  ...
  return (
    <InternalPageShell
      ...
      description="Explore confirmed Google Skills Arcade rewards by year. Each season keeps its own tier requirements, prize-slot rules, and swag announcements so older rewards never get mixed into the current season."
