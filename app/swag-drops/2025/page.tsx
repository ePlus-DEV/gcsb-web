    ...
    >
      ...
      <div className="not-prose space-y-10">
          ...
          {ARCADE_2025_SWAG_HISTORY.map((season) => {
            ...
            return (
              <a
                ...
                className="group rounded-2xl border border-slate-200 bg-white p-5 transition hover:border-cyan-300 hover:shadow-md dark:border-white/10 dark:bg-white/[0.03]"
              >
        ...
        {ARCADE_2025_SWAG_HISTORY.map((season) => (
          ...
          >
            <div className="mb-5 rounded-2xl border border-slate-200 bg-slate-50 p-5 dark:border-white/10 dark:bg-white/[0.025]">
