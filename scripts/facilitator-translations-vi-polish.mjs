const VI_OVERRIDES = {
  "Participating in Facilitator Program": "Đang tham gia Chương trình Facilitator",
  ...
  "66 eligible skill badges total": "Tổng cộng 66 huy hiệu kỹ năng đủ điều kiện",
  "No badges match these filters": "Không có huy hiệu phù hợp với bộ lọc",
  "Clear the search or select another track/status.":
    "Xóa từ khóa hoặc chọn lộ trình/trạng thái khác.",
  "Based on the July–September 2026 syllabus. Google's official syllabus and program records remain the final source of truth.":
    "Dựa trên giáo trình tháng 7–9/2026. Giáo trình và dữ liệu chương trình chính thức của Google vẫn là nguồn xác nhận cuối cùng.",
  "Arcade games": "Trò chơi Arcade",
  ...
  "Build practical application, infrastructure, networking, and AI skills.":
    "Xây dựng kỹ năng thực hành về ứng dụng, hạ tầng, mạng và AI.",
  "Complete advanced infrastructure, security, data, and AI paths.":
    "Hoàn thành các lộ trình nâng cao về hạ tầng, bảo mật, dữ liệu và AI.",
  "Get Started with Google Cloud & AI": "Bắt đầu với Google Cloud và AI",
  "Dive Deeper into Google Cloud & AI": "Tìm hiểu sâu hơn về Google Cloud và AI",
  "Take Your Google Cloud & AI Skills to the Next Level":
    "Nâng kỹ năng Google Cloud và AI lên cấp độ tiếp theo",
  "Search syllabus badges": "Tìm huy hiệu trong giáo trình",
  "Search Facilitator syllabus badges": "Tìm huy hiệu giáo trình Facilitator",
  "Filter syllabus by learning track": "Lọc giáo trình theo lộ trình học",
  "Filter syllabus by completion status": "Lọc giáo trình theo trạng thái hoàn thành",
  "All tracks": "Tất cả lộ trình",
  ...
  "Include Facilitator Program bonus in the estimated total":
    "Cộng điểm thưởng Chương trình Facilitator vào tổng điểm ước tính",
}

const VI_DYNAMIC_OVERRIDES = {
  "__facilitator:bonusBadgesLeft": "+{bonus} điểm thưởng · còn {count} huy hiệu",
...
export function applyVietnameseFacilitatorPolish(catalogs) {
  const catalog = catalogs.vi
  if (!catalog) throw new Error("The Vietnamese website locale catalog is missing.")

  catalog.additional ??= {}
  Object.assign(catalog.additional, VI_OVERRIDES, VI_DYNAMIC_OVERRIDES)

  for (let count = 0; count <= 4; count += 1) {
    catalog.additional[`${count} of 4 found on the public profile.`] =
      `${count} trên 4 huy hiệu được tìm thấy trong hồ sơ công khai.`
  }
}
